          ...
          >
            ...
            >
              ...
              <p style={{ textShadow: "1px 1px 3px rgba(0, 0, 0, 0.1)" }}>
                I developed a website for Nigerian students and alumni of King
                Saud University in Riyadh, Saudi Arabia, utilizing{" "}
                <strong>ReactJS</strong> for the frontend and{" "}
                <strong>Django</strong> for the backend. The landing pages are
                dynamically fetched from the backend. The platform allows
                students and alumni to manage their profiles and connect with
                each other. Additionally, it features email notifications,
                enabling users to update their profiles, change their passwords,
                recover forgotten passwords, and delete their accounts.
              </p>
              <div>
              ...
              >
                ...
                >
                  Frontend Git{" "}
                  <i className="bi bi-github" style={{ marginLeft: "7px" }}></i>
                </a>
        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ textShadow: "1px 1px 3px rgba(0, 0, 0, 0.1)" }}>
                I built a Weather Forecast App that allows users to check
                current weather conditions, forecasts, and other relevant data
                for any location. The app fetches weather information from a
                public API and displays the data in a clean and intuitive
                interface. It can display the current temperature, humidity,
                wind speed, and weather conditions (e.g., clear, cloudy, etc.),
                as well as a forecast for the next three days.
              </p>
              <div>
                <h3 style={{ fontWeight: "bold" }}>TOOLS:</h3>
                <div
        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ textShadow: "1px 1px 3px rgba(0, 0, 0, 0.1)" }}>
                I developed a website for ABIOTECH NIGERIA LIMITED, a company
                that specializes in selling plumbing and building materials. The
                website showcases their products, provides detailed descriptions
                of each item, and allows customers to browse through different
                categories of materials. The website also includes a contact
                feature that makes it easy for customers to reach out to the
                company for inquiries, orders, or support.
              </p>
              <div>
                <h3 style={{ fontWeight: "bold" }}>TOOLS:</h3>
                <div
        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ textShadow: "1px 1px 3px rgba(0, 0, 0, 0.1)" }}>
                I remade a static website for Bill Gates School, located in
                India, as my first test project during my internship.
              </p>
              <div>
                <h3 style={{ fontWeight: "bold" }}>TOOLS:</h3>
                <div
